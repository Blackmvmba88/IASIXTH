...
class EarTrainingMode:
    ...
    def _identify_speaker(self, audio):
        ...
        # Aquí se podría implementar reconocimiento de speaker real
        return "yo" if len(self.live_transcriptions) % 2 == 0 else "otra_persona"
    ...
    def add_speaker(self, speaker_id, name, color=None):
        ...
        if not color:
            colors = ["\033[93m", "\033[95m", "\033[96m", "\033[97m"]  # Amarillo, Magenta, Cyan, Blanco
