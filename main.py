...
class CameraAI:
    ...
    def process_frame(self, frame):
        ...
        frame, person_detected = self.person_detector.detect_person(frame.copy())
    ...
    def run(self):
        ...
        while True:
            ...
            # Mostrar frame
            cv2.imshow('Cámara AI - Reconocimiento Inteligente', processed_frame)
            ...
            if key == ord('q'):
                ...
                if self.learning_object_name:
                    ...
                    self.selection_box = None
                    print(f"Modo aprendizaje activado para '{self.learning_object_name}'")
                ...
                if self.selection_box:
                    ...
                    if success:
                        print(f"Objeto '{self.learning_object_name}' aprendido!")
                        self.learning_mode = False
                        self.selection_box = None
                    else:
